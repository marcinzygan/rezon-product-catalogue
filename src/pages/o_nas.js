...
const o_nas = () => {
  return (
    <>
      <Head>
        <title>Rezon.eu - O nas</title>
        <meta name="description" content="Historia firmy rezon.eu" />
        ...
        <div className={classes.section__wrapper}>
          <div>
            ...
            <p className={classes.text}>
              Nasza firma rozpoczęła swoją działalność w 1996 roku,
              specjalizując się w bezpośrednim imporcie towarów z Chin. Przez
              ponad 20 lat naszą główną dziedziną była sztuczna biżuteria,
              ozdoby do włosów, modne dodatki, upominki oraz artykuły
              dekoracyjne. Do dziś ten asortyment stanowi znaczną część naszej
              sprzedaży.
            </p>
          </div>
          <div>
            ...
            <p className={classes.text}>
              ...
              firmy, skupiając się na produkcji upominków, biżuterii i dekoracji
              w Polsce. Nasza oferta obejmuje teraz ciekawe i przydatne
              produkty, które z pewnością przypadną do gustu naszym klientom.
            </p>
          </div>
          <div>
            <h4 className={classes.h4__txt}>Prezenty i gadżety reklamowe</h4>
            <p className={classes.text}>
              Nasze produkty doskonale sprawdzają się jako prezenty lub
              oryginalne gadżety reklamowe. W naszym asortymencie znajduje się
              szeroki wybór biżuterii, obejmujący różnego rodzaju kolczyki i
              ...
              puszczające bańki mydlane oraz zakręcone, gumowe zwierzaki, piłki
          ...
          <div>
            ...
            <p className={classes.text}>
              Oprócz biżuterii i zabawek, w naszym asortymencie znajdują się
              także różnego rodzaju oryginalne gadżety reklamowe, które mogą być
          ...
          <div>
            ...
            <p className={classes.text}>
              ...
              Twoje pytania i wątpliwości. Jeśli potrzebujesz dodatkowych
              informacji lub masz jakiekolwiek zapytania, nie wahaj się
              skontaktować z nami. Jesteśmy dostępni pod wskazanymi danymi
              kontaktowymi i chętnie pomożemy.<br></br>
              Dziękujemy za odwiedzenie naszej strony i zapraszamy do
